...
/**
 * This class contains an array of account objects and methods for different
 * account operations like finding an account, making a deposit/withdrawal,
 * sorting the accounts by dateOpen or lastName, or printing the account list.
 * 
...
public class AccountDatabase {
    ...
    /**
     * Constructor for AccountDatabase class. sets initialSize to 5 and size, which
     * keeps track of the number of accounts in the DB.
     */
     ...
     * 
     * @param account a account wrapper Account class, containing only the desired
    ...
    /**
     * This method return false if account exists, adds account to database and
     * grows if necessary.
     * 
     * @param account the account object to be added to the database
     * @return false if account is already in database, returns true if account can
     *         be added
     */
    ...
    /**
     * This method removes the passed-in account from the database if it exists. The
     * last item in the accounts array replaced the removed item with the index, and
     * the index of the last item is set to null.
     * 
     ...
     * @return returns 0 on successful withdrawal, 1 if balance is less than amount,
    ...
    /**
     * This is a helper method that prints out the necessary information in the
     * dateOpen and lastName print methods. It is called in each of the methods to
     * reduce redundancy.
     */
