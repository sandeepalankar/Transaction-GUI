...
public class MainController {
	...
	/**
	 * This method handles all the button requirements for the Savings, Checking, and MoneyMarket buttons. 
	...
	/**
	 * This method opens a new account given a String[] of inputs containing the account type, holder's
	 * first and last name, starting account balance
	...
	/**
	 * This method closes an account given a String[] of inputs containing the account type, holder's
	 * first and last name, and account balance.
	...
	/**
	 * This method opens the File Explorer and allows the user to select a text file to import for
	...
	void chooseFile(ActionEvent event) {
		...
		File sourceFile = chooser.showOpenDialog(theStage);
		try {
	...
	/**
	 * Depending on whether the Import RadioButton is clicked or the Export RadioButton is clicked,
	 * this method will either call the import or exportDatabase methods.
	...
	/**
	 * This method imports a text file filled with different account operations that can be used to
	 * test the Transaction Manager GUI. The text file is appended to the TextArea line by line
	 * and the file path is checked to make sure it is valid.
	...
	/**
	 * This method calls the createAccount method given an array of input Strings that represent
	 * each of the necessary elements to open a new account. The method also checks if the account in 
	 * question is already in the account database, in which case it is not opened again.
	 * @param input array of Strings representing first and last name, date opened, balance, 
	 * and account options
	 ...
	 * @throws Exception "Invalid input for number of withdrawals." Thrown if string cannot be converted to int.
	 */
	...
	/**
	 * This method is used to export a file and checks if the specified file is a txt file. If the 
	 * operation is successful, the necessary text is appended to the TextArea and if not, the exception
	 * is caught and the exception message is printed to the TextArea.
	...
	private static void exportDatabase(String path, TextArea textArea) {
		...
		if(!path.endsWith(".txt"))
			path = path + ".txt";
		textArea.appendText("Exporting Database.\n");
		try {
	...
	/**
	 * This method displays the accounts currently in the account database and depending on which
	 * RadioButton is selected, the accounts will be appended to the TextArea in a different order.
	...
	/**
	 * This method calls either the withdraw or deposit method depending on whether the
	 * deposit or withdraw RadioButton is selected. It creates an array of Strings that contains 
	 * the account type, holder first and last name, and amount to be deposited/withdrawn.
	...
	/**
	 * This method is called to deposit an amount into an account. The amount is properly formatted, 
	 * and the resultant account is return in String format.
	 * @param input array containing account balance
	 * @return appropriate String representing amount deposited into account, if possible
	 */
	...
	/**
	 * This method is called to withdraw a certain amount from an account. It formats the
	 * withdrawal amount, and checks if the operation is possible, then prints the necessary text.
	 * @param input that contains String representation of account balance
	 * @return appropriate String representing amount withdrawn from account, if it was possible
	 */
